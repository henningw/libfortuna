...
fortuna:
	...
	$(CC) -c -fPIC -I. $(CFLAGS) -g -Wall -Werror ./src/fortuna.c ./src/rijndael.c ./src/sha2.c ./src/px.c ./src/random.c ./src/internal.c ./src/sha1.c ./src/md5.c
	$(AR) rvs libfortuna.a fortuna.o rijndael.o px.o sha2.o random.o internal.o sha1.o md5.o
	$(CC) -shared -fPIC -o libfortuna.so fortuna.o rijndael.o px.o sha2.o random.o internal.o sha1.o md5.o
